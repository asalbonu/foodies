        ...
        <div class="contact-sec py-5">
            <div class="container py-md-4 py-3">
                <div class="contact-w3pvt-form">
                    ...
                    <form method="post" class="w3layouts-contact-fm" action="in.php">
                        <div class="row main-cont-sec">
                            <div class="col-md-6 left-cont-contact">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="wName" id="w3lName" placeholder=""
                                        required="">
                                </div>
                                <div class="form-group">
                        ...
                        <div class="form-group-2 mt-4">
                            <button type="submit" name="sub" class="btn button-style d-flex ml-auto">Send Now</button>
                        </div>
                    </form>
