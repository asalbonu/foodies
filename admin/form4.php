        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form action="upd3.php"  method="post" enctype="multipart/form-data">
              <form action="?page=3"  method="post" enctype="multipart/form-data">
                <div class="card-body">
                <div class="form-group" style="align-content: center;">
                            <label for="exampleInputEmail1">Name</label>
                            <input type="name" class="form-control" name="name" value="<?=$b[1]?>">
                            <input type="hidden" name="id" value="<?=$b[0]?>">
                          </div>
                          <div class="form-group">
                            <label for="exampleInputPassword1">Price</label>
                            <input type="number" class="form-control" name="price" value="<?=$b[2]?>">
                          </div>
                          <div class="form-group">
                          ...
                          <div class="col-md-6 right-cont-contact mt-md-0 mt-1">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="desc"><?=$b[3]?></textarea>
                                </div>
                            </div>
                <!-- /.card-body -->
